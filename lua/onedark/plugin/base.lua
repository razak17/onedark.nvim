...
return {
	...
	qfLineNr = { fg = P.cyan },
	CursorLineNr = { fg = tint(P.orange, -0.1), bold = true },
	diffAdded = { bg = P.diff_add },
	DiffAdd = { link = "diffAdded" },
	DiffTextAdd = { bg = P.diff_delete },
	DiffAddedChar = { bg = P.diff_delete },
	DiffChange = { bg = P.diff_delete },
	DiffChangedChar = { bg = P.cyan },
	diffRemoved = { bg = P.diff_delete },
	DiffDelete = { link = "diffRemoved" },
	DiffDeleteAlt = { bg = P.diff_delete_alt },
	DiffText = { bg = P.diff_change_inline },
